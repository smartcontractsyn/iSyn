...
contract IndentureAgreement_4 {
    ...
    constructor() public payable {
        ...
        sellerName = "WILMINGTON TRUST, NATIONAL ASSOCIATION";
        seller = address(0);
        buyerName =["Neiman Marcus Group LTD LLC；The Neiman Marcus Group LLC；Mariposa Borrower, INC.；The NMG Subsidiary LLC"];
        buyer =[address(0)];
    }
