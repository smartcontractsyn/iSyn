...
contract MiscAgreement_3 {
    ...
    uint[4] public pricePayedByBuyer;
    bool[4] public purchaseSellerConfirmed;
    bool[4] public purchaseBuyerConfirmed;
    mapping(string => uint32) fileHashMap;
    bool[4] public terminateSellerConfirmed;
    bool[4] public terminateBuyerConfirmed;
    enum State {
        Created, Locked, Release, Transfered, Inactive }
    State[4] public state;
    ...
    constructor() public payable {
        ...
        CloseTime = 1621008000;
        OutSideClosingDate = 1624982400;
        sellerName = "CRÉDIT AGRICOLE CORPORATE AND INVESTMENT BANK";
        seller = address(0);
        buyerName =["EMERY SHIPPING CORPORATION", "MANDORA SHIPPING LTD", "RONDINE MANAGEMENT CORP", "SOLANGE SHIPPING LTD"];
        buyer =[address(0), address(0), address(0), address(0)];
    }
