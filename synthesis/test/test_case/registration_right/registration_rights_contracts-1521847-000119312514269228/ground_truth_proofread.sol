...
contract RegistrationRightAgreement_6 {
    ...
    constructor() public payable {
        EffectiveTime = 1405267200;
        CloseTime = 1405526400;
        OutSideClosingDate = 1000;
        sellerName = "MEMORIAL PRODUCTION PARTNERS LP；MEMORIAL PRODUCTION FINANCE CORPORATION";
        seller = address(0);
        buyerName =["Barclays Capital Inc."];
        buyer =[address(0)];
    }
