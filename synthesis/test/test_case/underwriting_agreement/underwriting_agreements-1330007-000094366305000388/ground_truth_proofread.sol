...
contract UnderwritingAgreement_4 {
    ...
    uint[3] public pricePayedByBuyer;
    bool[3] public purchaseSellerConfirmed;
    bool[3] public purchaseBuyerConfirmed;
    mapping(string => uint32) fileHashMap;
    bool[3] public terminateSellerConfirmed;
    bool[3] public terminateBuyerConfirmed;
    enum State {
        Created, Locked, Release, Transfered, Inactive }
    State[3] public state;
    ...
    constructor() public payable {
        EffectiveTime = 1119369600;
        CloseTime = 1120060800;
        OutSideClosingDate = 1000;
        sellerName = "Wachovia Commercial Mortgage Securities, Inc.";
        seller = address(0);
        buyerName =["Wachovia Capital Markets", "LLC Citigroup Global Markets Inc", "Credit Suisse First Boston LLC"];
        buyer =[address(0), address(0), address(0)];
    }
